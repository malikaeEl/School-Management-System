...
const Sidebar = () => {
  ...
  const allMenuItems = [
    ...
    { title: 'Messaging', icon: 'chat', path: '/messaging', roles: ['admin', 'teacher', 'student', 'parent', 'librarian', 'finance'], arabic: 'الرسائل', french: 'Messagerie' },
    { title: 'Library', icon: 'local_library', path: '/library', roles: ['admin', 'librarian', 'student'], arabic: 'المكتبة', french: 'Bibliothèque' },
    { title: 'Transport & GPS', icon: 'directions_bus', path: '/transport', roles: ['admin'], arabic: 'النقل', french: 'Transport & GPS' },
    ...
    { title: 'Online Learning', icon: 'online_prediction', path: '/online-learning', roles: ['admin', 'teacher', 'student'], arabic: 'التعلم عن بعد', french: 'Apprentissage en ligne' },
