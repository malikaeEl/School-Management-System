...
const StudentDashboard = () => {
  ...
  const { profile, subjects, exams, attendance, timetable, library, events } = data || {};
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/events" className="text-[9px] font-black text-moroccan-green uppercase tracking-widest hover:underline">{t('view_all')}</a>
            </div>
            ...
            <a href="/events" className="mt-4 block w-full py-3 bg-slate-50 border border-dashed border-slate-200 rounded-2xl text-[9px] font-black text-slate-400 uppercase tracking-widest hover:bg-moroccan-gold/5 hover:text-moroccan-gold hover:border-moroccan-gold/30 transition-all text-center">
